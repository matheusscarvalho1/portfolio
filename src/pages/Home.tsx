        ...
        <main className="flex flex-col justify-center items-center p-6 md:p-8 bg-background text-foreground min-h-screen transition-colors duration-500">
                ...
                <div className="flex flex-col-reverse xl:flex-row items-center gap-10 md:gap-25">
                    <div className="flex flex-col justify-center flex-1 text-center xl:text-left">
                        ...
                        <div className="flex flex-wrap items-center justify-center gap-4 md:gap-6 mt-8 xl:justify-start">
                            ...
                            >
                                <a href="/matheus-scarvalho-cv.pdf" download aria-label="Baixar currículo em PDF">
                                    DOWNLOAD CV <DownloadIcon className="w-5 h-5 ml-2" aria-hidden="true" />
                                </a>
                            </Button>
                            ...
                            <div className="flex gap-4">
                                ...
                                >
                                    <a href="https://www.linkedin.com/in/matheusscarvalho/" target="_blank" rel="noopener noreferrer" aria-label="Acessar perfil do LinkedIn (abre em nova aba)">
                                ...
                                <Button 
                                    ...
                                    className="bg-transparent rounded-full w-12 h-12 border-2 border-dracula-green text-dracula-green hover:bg-dracula-green hover:text-background transition-all"
                                >
                                    <a href="https://github.com/matheusscarvalho1" target="_blank" rel="noopener noreferrer" aria-label="Acessar perfil do GitHub (abre em nova aba)">
            ...
            <div className="flex flex-wrap gap-8 md:gap-16 mt-16 md:mt-24 justify-center border-t border-border pt-10 w-full max-w-5xl">
                <div className="text-center min-w-30">
                    <h3 className="text-4xl md:text-5xl font-bold text-dracula-green mb-1" aria-label="3 anos de experiência">
                ...
                <div className="text-center min-w-30">
                    <h3 className="text-4xl md:text-5xl font-bold text-dracula-orange mb-1" aria-label="Mais de 6 projetos robustos">
                ...
                <div className="text-center min-w-30">
                    <h3 className="text-4xl md:text-5xl font-bold text-dracula-cyan mb-1" aria-label={`Total de ${totalPublicRepos} repositórios públicos no GitHub`}>
                ...
                <div className="text-center min-w-30">
                    <h3 className="text-4xl md:text-5xl font-bold text-dracula-secondary mb-1" aria-label={`Total de ${totalCommitsGlobal} commits no GitHub`}>
